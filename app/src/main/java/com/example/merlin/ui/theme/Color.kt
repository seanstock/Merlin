...
// 🌿 SOPHISTICATED COOL PALETTE 🌿
// Inspired by Montessori & Reggio Emilia principles
...
val IvoryWhite = Color(0xFFFFFBEB)       // Warm white
val StormyGray = Color(0xFF475569)       // Sophisticated gray
...
val SeafoamMist = Color(0xFFD1FAE5)      // Very light green
val IceBlue = Color(0xFFDBEAFE)          // Very light blue
...
// Alias the new colors to old names for compatibility
val MagicalBlue = WisdomBlue
...
val CloudWhite = IvoryWhite
val MidnightMagic = MidnightNavy
val SparkleGold = AmberGlow           // Toned down
val CrystalBlue = WisdomBlue
